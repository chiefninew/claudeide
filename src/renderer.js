...
const RELEASES = [
  ['0.5.21', 'Title-bar drag across monitors no longer grows the window: the drag now pins the window size, so crossing a different-DPI monitor can\'t rescale it'],
